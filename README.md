...
**Windows PowerShell:**
```powershell
.\make.ps1 setup                              # crear entorno conda
.\make.ps1 train                              # entrenar modelo + calibradores + umbrales
python scripts\generate_sample_input.py       # generar sample de entrada
python -m tests.generate_golden               # generar archivo dorado (una vez)
.\make.ps1 e2e                                # ejecutar pipeline end-to-end
```
